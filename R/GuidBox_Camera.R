...
for (i in 1:length(numerator.names)) {
        ...
        print(c(sum(before.both.dev[numerator.name]),
              sum(after.both.dev[numerator.name] - before.both.dev[numerator.name]),
              sum(before.dev[numerator.name]),
              sum(after.dev[numerator.name])))
        # if (i == 1){
